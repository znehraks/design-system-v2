...
`DesignCProvider` is also part of this boundary. Product apps can use it for nested theme boundaries, while static root themes can use plain `data-dc-theme` and `data-dc-mode` attributes for zero-runtime setup.
